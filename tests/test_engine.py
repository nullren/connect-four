...
class TestDraw:
    def test_full_board_no_winner(self) -> None:
        ...
        draw_moves = [
            ...
            1,
            0,
            1,  # col 0: 1,1,1 col 1: 2,2,2 (3 each)
            1,
            0,
            1,
            0,
            1,
            0,  # col 0: 2,2,2 col 1: 1,1,1 (full both)
            2,
            3,
            2,
            3,
            2,
            3,  # col 2: 1,1,1 col 3: 2,2,2
            3,
            2,
            3,
            2,
            3,
            2,  # col 2: 2,2,2 col 3: 1,1,1 (full both)
            4,
            5,
            4,
            5,
            4,
            5,  # col 4: 1,1,1 col 5: 2,2,2
            5,
            4,
            5,
            4,
            5,
            4,  # col 4: 2,2,2 col 5: 1,1,1 (full both)
            6,
            6,
            6,
            6,
